...
const TodoList2 = () => {
  ...
  const remove_todo =(index)=>{
    const updated_todos = todos.filter((_,i) => i !== index );// basically it creates a new list(updated_todo), which stores elements whose index does not match with the in
